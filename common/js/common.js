...
$(function(){
	$(document).on("click",".posR .btn_close",function(){
		console.log("여기");
...
$(function(){
	...
	if (Mobile()){// 모바일일 경우
		$(".header_cont").append("<button type='button' class='btn_mob_menu'><em>메뉴</em></button>");
		$(document).on("click",".btn_mob_menu",function(){
			$("#nav_gnb").toggleClass("on");
			$("body").append("<div class='dimm'></div>");
		});
	} else {// 모바일 외
		console.log("컴퓨터");
