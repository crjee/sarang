...
<%
	...
	If page_move = "prev" Then
		...
		sql = sql & "       ,notice_seq as prev_seq                                               "
		sql = sql & "   from gi_notice                                                            "
		sql = sql & "  where menu_seq = '" & menu_seq & "'                                        "
		sql = sql & "    and notice_seq > '" & notice_seq & "'                                     "
	...
	ElseIf page_move = "next" Then
		...
		sql = sql & "       ,notice_seq as next_seq                                               "
		sql = sql & "   from gi_notice                                                            "
		sql = sql & "  where menu_seq = '" & menu_seq & "'                                       "
		sql = sql & "    and notice_seq < '" & notice_seq & "'                                     "
	...
	' Response.write "notice_seq : " & notice_seq & "<br>"
...
%>
						...
						<script>
							document.getElementById("linkBtn").onclick = function() {
								try{
									if (window.clipnoticeData) {
											window.clipnoticeData.setData("text", "<%=link%>")
											alert("해당 URL이 복사 되었습니다. Ctrl + v 하시면 붙여 넣기가 가능합니다.");
									}
									else if (window.navigator.clipnotice) {
											window.navigator.clipnotice.writeText("<%=link%>").then(() => {
												alert("해당 URL이 복사 되었습니다. Ctrl + v 하시면 붙여 넣기가 가능합니다.");
											});
									}
									else {
...
<script>
//	function goWrite() {
//		document.search_form.action = "notice_write.asp"
//		document.search_form.target = "_self";
//		document.search_form.submit();
//	}

//	function goReply() {
//		document.search_form.action = "notice_reply.asp"
//		document.search_form.target = "_self";
//		document.search_form.submit();
//	}

//	function goModify() {
//		document.search_form.action = "notice_modify.asp"
//		document.search_form.target = "_self";
//		document.search_form.submit();
//	}
...
//		try{
//			if (window.clipnoticeData) {
//					window.clipnoticeData.setData("text", "<%=pageUrl%>")
//					alert("해당 글주소가 복사 되었습니다. Ctrl + v 하시면 붙여 넣기가 가능합니다.");
//			}
//			else if (window.navigator.clipnotice) {
//					window.navigator.clipnotice.writeText("<%=pageUrl%>").then(() => {
//						alert("해당 글주소가 복사 되었습니다. Ctrl + v 하시면 붙여 넣기가 가능합니다.");
//					});
//			}
//			else {
...
//			if (window.clipnoticeData) {
//					window.clipnoticeData.setData("text", str)
//					alert("해당 제목이 복사 되었습니다. Ctrl + v 하시면 붙여 넣기가 가능합니다.");
//			}
//			else if (window.navigator.clipnotice) {
//					window.navigator.clipnotice.writeText(str).then(() => {
//						alert("해당 제목이 복사 되었습니다. Ctrl + v 하시면 붙여 넣기가 가능합니다.");
//					});
//			}
//			else {
...
//		document.search_form.action = "notice_view.asp"
//		document.search_form.target = "_self";
//		document.search_form.submit();
//	}
...
//		}
//		else {
//			document.search_form.action = "notice_list.asp";
//		}
//		document.search_form.target = "_self";
//		document.search_form.submit();
//	}
