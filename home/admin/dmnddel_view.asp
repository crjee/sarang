		...
		<main id="adm_body">
			...
			<div class="btn_box view_btn">
				...
				<select id="dmnd_prcs_cd" name="dmnd_prcs_cd" class="sel w100p">
					...
					<%=GetMakeCDCombo("dmnd_prcs_cd", dmnd_prcs_cd)%>
				</select>
...
%>
									...
									<img src="/cafe/img/inc/file.png" /> <%=idcd_file_nm%></a>
<%
	End If
%>
								</td>
...
%>
									...
									<img src="/cafe/img/inc/file.png" /> <%=brct_file_nm%></a>
<%
	End If
%>
								</td>
...
%>
									...
									<img src="/cafe/img/inc/file.png" /> <%=agt_idcd_file_nm%></a>
<%
	End If
%>
								</td>
...
%>
									...
									<img src="/cafe/img/inc/file.png" /> <%=dlgt_file_nm%></a>
<%
	End If
%>
								</td>
...
%>
									...
									<img src="/cafe/img/inc/file.png" /> <%=atch_data_file_nm%></a>
<%
	End If
%>
								</td>
