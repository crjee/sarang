...
<%If job    = "0" then%>
								<li><button type="button" menuSeq="0" value="job" class="btn_adm">채용</button><input type="hidden" name="menu_seq"><input type="hidden" name="menu_type" value="job"><input type="hidden" name="page_type" value=""><input type="hidden" name="menu_name" value="채용"></li>
<%End If%>
<%If nsale  = "0" then%>
								<li><button type="button" menuSeq="0" value="member" class="btn_adm">분양소식</button><input type="hidden" name="menu_seq"><input type="hidden" name="menu_type" value="nsale"><input type="hidden" name="page_type" value=""><input type="hidden" name="menu_name" value="분양소식"></li>
<%End If%>
<%If land   = "0" then%>
								<li><button type="button" menuSeq="0" value="land" class="btn_adm">부동산뉴스</button><input type="hidden" name="menu_seq"><input type="hidden" name="menu_type" value="land"><input type="hidden" name="page_type" value=""><input type="hidden" name="menu_name" value="부동산뉴스"></li>
<%End If%>
							</ul>
						</div>
					</div>
