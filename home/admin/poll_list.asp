...
<%
	...
	sql = sql & "  where a.cafe_id = '" & cafe_id & "' "
	sql = sql & "    and a.poll_seq = b.poll_seq "
					...
					<tbody>
						...
						<tr>
							...
							<td>
								...
								<input type="radio" class="inp_radio" id="ddln_yn_n" name="ddln_yn" value="N" checked required />
	...
	function onEdit(poll_seq) {
		...
		try {
			...
			$.ajax({
				type: "POST",
				dataType: "json",
				url: "/home/admin/poll_view_ajax.asp",
