...
%>
					<div class="pagenation">
						<button type="button" class="btn btn_c_peach f_awesome btnPrev" onclick="MovePage(1, '<%=session("ctTarget")%>')"><em><<</em></button>
<%
...
%>
						<button type="button" class="btn btn_c_peach f_awesome btnPrev" onclick="MovePage(<%=BlockStart-1%>, '<%=session("ctTarget")%>')"><em>이전</em></button>
<%
	Else
%>
...
%>
						<button type="button" class="btn btn_c_peach f_awesome btnNext" onclick="MovePage(<%=BlockEnd+1%>, '<%=session("ctTarget")%>')"><em>다음</em></button>
<%
	Else
%>
...
<%
	End If
%>
						<button type="button" class="btn btn_c_peach f_awesome btnNext" onclick="MovePage(<%=PageCount%>, '<%=session("ctTarget")%>')"><em>>></em></button>
					</div>
