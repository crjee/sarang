...
%>
						<button type="button" class="btn btn_c_a btn_s" onclick="<%=session("svHref")%>location.href='/home/waste_album_list.asp?menu_seq=<%=menu_seq%>'">휴지통</button>
<%
	End If

	If write_auth <= cafe_mb_level Then ' 글쓰기 권한
%>
						<button type="button" class="btn btn_c_a btn_s" onclick="<%=session("svHref")%>location.href='/home/album_write.asp?menu_seq=<%=menu_seq%>'">글쓰기</button>
<%
	End If
%>
...
%>
					<div class="btn_box algR">
						<button type="button" class="btn btn_c_a btn_n" onclick="<%=session("svHref")%>location.href='/home/album_write.asp?menu_seq=<%=menu_seq%>'">글쓰기</button>
					</div>
<%
	End If
%>
