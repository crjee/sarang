...
<script>
//	function goWrite() {
//		document.search_form.action = "sale_write.asp"
//		document.search_form.target = "_self";
//		document.search_form.submit();
//	}

//	function goReply() {
//		document.search_form.action = "sale_reply.asp"
//		document.search_form.target = "_self";
//		document.search_form.submit();
//	}

//	function goModify() {
//		document.search_form.action = "sale_modify.asp"
//		document.search_form.target = "_self";
//		document.search_form.submit();
//	}
...
//		try{
//			if (window.clipsaleData) {
//					window.clipsaleData.setData("text", "<%=pageUrl%>")
//					alert("해당 글주소가 복사 되었습니다. Ctrl + v 하시면 붙여 넣기가 가능합니다.");
//			}
//			else if (window.navigator.clipsale) {
//					window.navigator.clipsale.writeText("<%=pageUrl%>").then(() => {
//						alert("해당 글주소가 복사 되었습니다. Ctrl + v 하시면 붙여 넣기가 가능합니다.");
//					});
//			}
//			else {
...
//			if (window.clipsaleData) {
//					window.clipsaleData.setData("text", str)
//					alert("해당 제목이 복사 되었습니다. Ctrl + v 하시면 붙여 넣기가 가능합니다.");
//			}
//			else if (window.navigator.clipsale) {
//					window.navigator.clipsale.writeText(str).then(() => {
//						alert("해당 제목이 복사 되었습니다. Ctrl + v 하시면 붙여 넣기가 가능합니다.");
//					});
//			}
//			else {
...
//		document.search_form.action = "sale_view.asp"
//		document.search_form.target = "_self";
//		document.search_form.submit();
//	}
...
//		}
//		else {
//			document.search_form.action = "sale_list.asp";
//		}
//		document.search_form.target = "_self";
//		document.search_form.submit();
//	}
