...
<%
	...
	If task = "ins" Then
		...
		new_seq     = GetComSeq("gi_" & menu_type & "_comment")
		...
		sql = ""
		sql = sql & " insert into gi_" & menu_type & "_comment( "
		sql = sql & "        comment_seq "
		sql = sql & "       ,group_num "
		sql = sql & "       ,step_num "
		sql = sql & "       ,level_num "
		...
		sql = sql & "    set comment_cnt = (select count(" & menu_type & "_seq) from gi_" & menu_type & "_comment where " & menu_type & "_seq = '" & com_seq & "') "
