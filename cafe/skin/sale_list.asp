...
'If session("user_id") = "crjee" Then extime("cf_sale 실행시간")
	sql = ""
...
%>
						<button type="button" class="btn btn_c_a btn_s" onclick="<%=session("ctHref")%>location.href='/cafe/skin/waste_sale_list.asp?menu_seq=<%=menu_seq%>'">휴지통</button>
<%
	End If

	If write_auth <= cafe_mb_level Then ' 글쓰기 권한
%>
						<button type="button" class="btn btn_c_a btn_s" onclick="<%=session("ctHref")%>location.href='/cafe/skin/sale_write.asp?menu_seq=<%=menu_seq%>'">글쓰기</button>
<%
	End If
%>
...
'If session("user_id") = "crjee" Then extime("cf_sale top 실행시간")
	sql = ""
	sql = sql & " select sale_seq "
	sql = sql & "       ,subject "
	sql = sql & "       ,location "
...
%>
					<div class="btn_box algR">
						<button type="button" class="btn btn_c_a btn_n"" onclick="<%=session("ctHref")%>location.href='/cafe/skin/sale_write.asp?menu_seq=<%=menu_seq%>'">글쓰기</button>
					</div>
<%
	End If
%>
