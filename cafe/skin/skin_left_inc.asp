...
%>
					<li class="outline_zone">
						<ul>
							...
							%>
								<li><a href="/cafe/main.asp?cafe_id=<%=session("mycafe")%>"><img src="/cafe/skin/img/left/left_goclub.gif" alt="사랑방 바로가기" /></a></li>
							<%
								End If
							%>
							<%
							...
							%>
								<!--연합회 바로가기-->
								<li><a href="/cafe/main.asp?cafe_id=<%=union_id%>"><img src="/cafe/skin/img/left/left_gounited.gif" alt="" /></a></li>
								<!--연합회 바로가기-->
							<%
								End If
